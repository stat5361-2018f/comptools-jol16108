...
add
#> function (x, y, z) 
#> .Call(<pointer: 0x10e9d14e0>, x, y, z)
add(1, 2, 3)
#> [1] 6
```
...
#>   sum(x)  1.07  1.15  1.36   1.18  1.27     9.29   100
#>  sumC(x)  1.95  2.18 10.10   2.27  2.46   718.00   100
#>  sumR(x) 43.70 47.70 85.16  48.10 49.10 3,470.00   100
```
...
#> Unit: microseconds
#>         expr    min    lq   mean median     uq      max neval
#>  any_naR(x0) 172.00 308.0 463.23 336.00 377.00 6,830.00   100
#>  any_naC(x0) 191.00 200.0 236.33 218.00 243.00   447.00   100
#>  any_naR(x1) 173.00 309.0 352.35 347.00 387.00   691.00   100
#>  any_naC(x1) 191.00 199.0 230.88 216.00 231.00   915.00   100
#>  any_naR(x2)  78.90 221.0 263.29 244.00 286.00 1,190.00   100
#>  any_naC(x2)   1.21   1.7   2.49   2.21   2.79     8.15   100
```
...
#> Unit: microseconds
#>                expr   min    lq mean median    uq    max neval
#>    gibbs_r(100, 10) 3,850 4,480 6130  4,840 5,740 20,100   100
#>  gibbs_cpp(100, 10)   250   263  312    273   315  1,390   100
```
...
#> Unit: microseconds
#>   expr     min      lq   mean  median      uq   max neval
#>  vacc1 1,380.0 1,640.0 1965.0 1,780.0 2,050.0 4,960   100
#>  vacc2    81.0    95.5  184.2   106.0   133.0 6,590   100
#>  vacc3    12.1    14.0   27.3    16.5    19.5   946   100
```
