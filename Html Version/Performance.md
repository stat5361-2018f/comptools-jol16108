...
#>  sqrt(x)   545   566 1008    586   606 23,100   100
#>    x^0.5 2,670 2,720 3056  2,750 2,810  8,650   100
```
...
The `sqrt()` function takes about 700 ns, or 0.7 µs, to compute the square root of 100 numbers. That means if you repeated the operation a million times, it would take 0.7 s. So changing the way you compute the square root is unlikely to significantly affect real code.
...
#> Unit: nanoseconds
#>  expr    min     lq  mean median     uq       max neval
#>   fun    157    172   314    189    235     9,760   100
#>    S3    816  1,020  8047  1,200  1,390   662,000   100
#>    S4 10,200 12,100 43063 12,900 13,700 2,350,000   100
#>    RC  6,780  7,580 31976  8,070  8,600 2,390,000   100
```
...
#> Unit: nanoseconds
#>      expr min  lq mean median  uq       max neval
#>   f(1, 2) 301 323  612    349 420 1,560,000 10000
#>  f2(1, 2) 538 586  765    630 744    38,000 10000
#>  f3(1, 2) 567 616 1008    662 782 2,050,000 10000
#>  f4(1, 2) 594 647  850    693 815    49,500 10000
```
...
#> Unit: nanoseconds
#>  expr min  lq mean median  uq     max neval
#>  f0() 121 144  232    154 165 425,000 10000
#>  f1() 142 160  257    172 185 373,000 10000
#>  f2() 164 189  311    203 218 457,000 10000
#>  f3() 173 206  372    221 239 542,000 10000
#>  f4() 183 215  414    232 255 412,000 10000
#>  f5() 205 233  466    252 280 604,000 10000
```
...
#> Unit: nanoseconds
#>           expr    min     lq  mean median     uq     max neval
#>       [32, 11] 11,600 12,000 13232 12,200 12,500  39,100   100
#>      $carb[32]  6,040  6,310  7066  6,650  6,970  24,400   100
#>  [[c(11, 32)]]  5,020  5,270  9975  5,460  5,780 441,000   100
#>     [[11]][32]  4,750  5,020  5683  5,250  5,510  21,700   100
#>       .subset2    336    396   453    430    464   2,090   100
```
...
#> Unit: microseconds
#>             expr   min    lq mean median   uq   max neval
#>       squish_ife 17.70 25.30 46.4  26.60 27.6 2,020   100
#>         squish_p  9.00  9.95 26.6  10.80 11.5 1,130   100
#>  squish_in_place  1.81  2.11 24.0   2.34  3.4 2,120   100
```
...
#> Unit: microseconds
#>             expr  min   lq  mean median   uq      max neval
#>  squish_in_place 2.06 2.18  3.02   2.34 3.79     9.34   100
#>       squish_cpp 1.72 1.86 30.66   1.95 2.16 1,920.00   100
```
...
#> Unit: milliseconds
#>          expr  min   lq  mean median    uq    max neval
#>  cond_sum_cpp 3.40 3.45  3.83   3.54  4.05   6.16   100
#>    cond_sum_r 7.43 7.88 10.65   9.70 10.40 124.00   100
```
