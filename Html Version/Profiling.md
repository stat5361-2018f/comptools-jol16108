...
#>  mean2(x)   544   581 18232    629   672 1,760,000   100
```
...
#>  mean.default(x) 1.05 1.10 1.16   1.12 1.16  2.95   100
```
...
#>  as.data.frame 1,100.00 1,200.00 1391.7 1,250.0 1,420.0 5,110   100
```
...
#>  diff4(x) 1.97 3.13  38.71   3.34 4.36  3,490.0   100
```
...
#>  boot_cor2(df, 10) 59.5  69.1  121   71.8  74.9 2,890   100
```
...
#>  lookup[x100] 4,540 4,870 5548  5,040 6,330 11,800   100
```
...
#>   vec100  29.80  31.90  40.87  35.90  42.6   155.0   100
```
...
#>     lapply(x, is.null) 2.13 2.21  2.28   2.23 2.27     4.91   100
```
...
#>  rowtstat_bc(X, grp) 0.523 0.721 1.041  0.811 0.919 20.90   100
```
